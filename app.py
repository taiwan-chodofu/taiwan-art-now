                ...
                if evt_date >= today_date:
                    ...
                    if evt.get("type") == "notice":
                        if next_notice is None:
                            next_notice = {"date": evt["date"], "time": evt.get("time", ""), "title": evt_title, "note": evt_note, "days_until": days_until}
...
DISCOVER_LABELS = {
    "en": {
        ...
        "tutorial_seen": "Not sure yet? Swipe left to skip for now",
        "tutorial_tap": "Tap the card for full details, or tap “Already seen” once you have",
    ...
    "ja": {
        ...
        "tutorial_seen": "まだ決められない？左にスワイプで一旦スキップ",
        "tutorial_tap": "タップで詳細を表示。観た後は「観た」ボタンで記録",
    ...
    "zh": {
        ...
        "tutorial_seen": "還沒決定？向左滑動先略過",
        "tutorial_tap": "點擊卡片查看詳情，看過後可按「已看過」",
